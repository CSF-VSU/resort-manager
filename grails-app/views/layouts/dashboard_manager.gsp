    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav">
                <li class="active">
                    <a href="#"><i class="fa fa-fw fa-dashboard"></i> Бронирование</a>
                </li>
                <li>
                    <a href="#"><i class="fa fa-fw fa-arrow-circle-left"></i> Номера</a>
                </li>
                <li>
                    <a href="#"><i class="fa fa-fw fa-bar-chart-o"></i> Отчёты</a>
                </li>
            </ul>
        </div>
        <!-- /.navbar-collapse -->
